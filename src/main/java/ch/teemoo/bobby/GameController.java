...
public class GameController {
    ...
    void displayGameInfo(Move move) {
        boolean showPopup = (game.getWhitePlayer() != null && !game.getWhitePlayer().isBot()) || (game.getBlackPlayer() != null && !game.getBlackPlayer().isBot());
        GameState state;
        ...
        switch (state) {
            case LOSS:
                ...
                if (winner.isBot()) {
                    ...
                    if (loser != null && loser.isBot())
                        info("Checkmated?!? Noooo! How is this possible?\nCongrats, not everybody is able to beat the genius Bobby!", showPopup);
                    else
